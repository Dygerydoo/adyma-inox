...
This theme is ready to expand the functionality with Plugins:
Contact Form 7

== Description ==

Rectangulum is a simple and practical Full Responsive layout Theme with a full width image header for publishers and entrepreneurs.

All theme settings using WordPress theme Customizer in live preview. Rectangulum uses the built-in WordPress theme Customizer for simple theme customizations including custom logo upload, the color of all elements, homepage selection, footer text and more.

Theme Features include a front-page with a full-width background image, flexslider for sticky posts and gallery slideshow layout, custom all color and logo upload using the Customizer live preview, toggled additional top-bar and list of comments, separate sidebar for pages and posts, full-width page templates and translation-ready. Included translations: Russian.
